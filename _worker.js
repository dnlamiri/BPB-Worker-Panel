...
function generateRemark(index, port, protocol, fragType) {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `بنیامین-${protocol}${type} - Domain ${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `بنیامین-${protocol}${type} - IPv4 ${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `بنیامین-${protocol}${type} - IPv6 ${index - 3} : ${port}`;
            break;
        default:
            remark = `بنیامین-${protocol}${type} - Clean IP ${index - 5} : ${port}`;
            break;
    }
...
async function renderHomePage (env, hostName, fragConfigs) {
            ...
            <tr>
                <td>
                    ${config.address === 'Best-Ping' 
                        ? `<div  style="justify-content: center;"><span><b>بنیامین-F - بهترین پینگ 🏎️</b></span></div>` 
                        : config.address === 'WorkerLess'
                            ? `<div  style="justify-content: center;"><span><b>بنیامین-F - YouTube(یوتیوب) 📺</b></span></div>`
                            : config.address === 'Best-Fragment'
                                ? `<div  style="justify-content: center;"><span><b>بنیامین-F - فرگمنت خودکار 🔥</b></span></div>`
                                : config.address
                    }
                </td>
                <td>
	...
	<head>
        ...
        <title>بنیامین-${panelVersion}</title>
	...
	<body>
		<h1>بنیامین<span style="font-size: smaller;">${panelVersion}</span> </h1>
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/sub/${userID}#بنیامین-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}#بنیامین-Normal', false)">
					...
					<tr>
						...
						<td>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=singbox#بنیامین-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
						</td>
					</tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/sub/${userID}?app=sfa#بنیامین-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=sfa#بنیامین-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/sub/${userID}?app=clash#بنیامین-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=clash#بنیامین-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
                <table id="frag-sub-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/fragsub/${userID}#بنیامین Fragment', 'Fragment Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/fragsub/${userID}#بنیامین Fragment', true)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}?app=xray#بنیامین-Warp', 'Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=xray#بنیامین-Warp', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
					</tr>
					<tr>
						...
						<td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/warpsub/${userID}?app=singbox#بنیامین-Warp', 'Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=singbox#بنیامین-Warp', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
						</td>
					</tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}?app=clash#بنیامین-WARP', 'Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=clash#بنیامین-WARP', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
				<table id="warp-pro-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}?app=nikang#بنیامین-Warp-Pro', 'Warp Pro Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=nikang#بنیامین-Warp-Pro', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
					</tr>
					<tr>
						...
						<td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/warpsub/${userID}?app=hiddify#بنیامین-Warp-Pro', 'Warp Pro Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=hiddify#بنیامین-Warp-Pro', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
						</td>
					</tr>
    ...
    warpEndpoints.split(',').forEach( (endpoint, index) => {
        ...
        if (client === 'singbox' || client === 'hiddify') {
            let singboxOutbound = buildSingboxWarpOutbound(
                client === 'hiddify' ? `بنیامین-Warp Pro ${index + 1} 🇮🇷` : `بنیامین-Warp ${index + 1} 🇮🇷`, 
                warpIPv6, 
                privateKey, 
                publicKey, 
                endpoint,
        ...
        if (client === 'clash') {
            let clashOutbound = buildClashWarpOutbound(`بنیامین-Warp ${index + 1} 🇮🇷`, warpIPv6, privateKey, publicKey, endpoint, reserved, '');
        ...
        for (let i = 0; i < 2; i++) {
            ...
            if (client === 'clash') {
                let clashOutbound = buildClashWarpOutbound(
                    i === 1 ? `warp-ir_${index + 1}` : `بنیامین-WoW ${index + 1} 🌍`, 
                    warpIPv6, 
                    privateKey, 
                    publicKey, 
                    endpoint,
...
async function buildWorkerLessConfig(env, client) {
    ...
    fragConfig.remarks  = 'بنیامین-F - YouTube(یوتیوب) 📺'
...
async function getFragmentConfigs(env, hostName, client) {
    ...
    bestPing.remarks = 'بنیامین-F - Best Ping 🏎️';
    ...
    bestFragment.remarks = 'بنیامین-F - Best Fragment 🔥';
...
async function getXrayWarpConfigs (env, client) {
    ...
    xrayWarpBestPing.remarks = client === 'nikang' ? 'بنیامین- Warp Pro Best Ping 🚀' : 'بنیامین- Warp Best Ping 🚀';
    ...
    xrayWarpOutbounds.forEach((outbound, index) => {
        xrayWarpConfigs.push({
            ...xrayWarpConfig,
            remarks: client === 'nikang' ? `بنیامین- Warp Pro ${index + 1} 🇮🇷` : `بنیامین- Warp ${index + 1} 🇮🇷`,
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = client === 'nikang' ? `بنیامین- WoW Pro ${index/2 + 1} 🌍` : `بنیامین- WoW ${index/2 + 1} 🌍`;
    ...
    xrayWoWBestPing.remarks = client === 'nikang' ? 'بنیامین- WoW Pro Best Ping 🚀' : 'بنیامین- WoW Best Ping 🚀';
        ...
        "proxy-groups": [
            {
                ...
                "type": "select",
                "proxies": isWarp
                    ? ['بنیامین-Warp Best Ping 🚀', 'بنیامین-WoW Best Ping 🚀', ...warpOutboundsRemarks, ...wowOutboundRemarks ]
                    : ['بنیامین-Best Ping 🏎️', ...outboundsRemarks ]
            },
            {
                "name": isWarp ? `بنیامین-Warp Best Ping 🚀`: `بنیامین-Best Ping 🏎️`,
                "type": "url-test",
...
async function getSingboxConfig (env, hostName, client, warpType) {
    ...
    if (warpType) {
        ...
        config.outbounds[0].outbounds = client === 'hiddify'
            ? ["بنیامین-Warp Pro Best Ping 🚀", "بنیامین- WoW Pro Best Ping 🚀"]
            : ["بنیامین-Warp Best Ping 🚀", "بنیامین-WoW Best Ping 🚀"];
        config.outbounds.splice(2, 0, structuredClone(config.outbounds[1]));
        config.outbounds[1].tag = client === 'hiddify' 
            ? "بنیامین-Warp Pro Best Ping 🚀"
            : "بنیامین-Warp Best Ping 🚀";
        config.outbounds[2].tag = client === 'hiddify'
            ? "بنیامین-WoW Pro Best Ping 🚀"
            : "بنیامین-WoW Best Ping 🚀";
    ...
    outbounds: [
        {
            type: "selector",
            tag: "proxy",
            outbounds: ["بنیامین-Best Ping 🏎️"]
        },
        {
            type: "urltest",
            tag: "بنیامین-Best Ping 🏎️",
            outbounds: [],
            url: "https://www.gstatic.com/generate_204",
            interval: "30s",
            tolerance: 50
